...
log_file_path = '/media/jithin/DATA/2024/ImageJ_Augmentation_project/models/classification/original_dataset/VGG16_training_log.txt'
...
for epoch in range(num_epochs):
    ...
    if accuracy > best_train_accuracy:
        ...
        best_checkpoint_path = f'/media/jithin/DATA/2024/ImageJ_Augmentation_project/models/classification/original_dataset/VGG16_best_model_checkpoint.pth'
        torch.save({
            'epoch': epoch+1,
